...
const PRODUCTS: Product[] = [
  ...
  { name: "جبنة بالمستكة",          accent: "معطرة بالمستكة الفاخرة", cat: "جبنة",    badge: "صناعة محلية",   img: "/p-cheese-mastika.png",    desc: "جبنة بيضاء طازجة معطرة بحبيبات المستكة الفاخرة لتمنح مائدتكم طعماً غنياً وملمساً كريمياً لا يُنسى." },
  { name: "جبنة اريش",              accent: "خفيفة وصحية",           cat: "جبنة",    badge: "طبيعي ١٠٠٪",    img: "/p-cheese-qareesh-new.png",        desc: "جبنة قريش خفيفة غنية بالبروتين الطبيعي — مثالية لفطور صحي ومتوازن في كل يوم." },
  { name: "شنكليش",                  accent: "موروث الشام الأصيل",    cat: "جبنة",    badge: "صناعة تقليدية", img: "/p-cheese-shanklish.png",      desc: "كرات جبنة مُعتَّقة بالزعتر وحبة البركة والتوابل الطبيعية — وصفة موروثة من جبال الشام." },

  { name: "جبنة مشللة",             accent: "بلدية على أصولها",      cat: "جبنة",    badge: "طازج يومياً",    img: "/p-cheese-masnaka.png",        desc: "جبنة مشللة بلدية خيوط، تُحضر يدوياً يومياً من الحليب الطازج بنكهة المحلب الفريدة." },
  { name: "لبنة طرية",              accent: "كريمية من مزارعنا",     cat: "لبنة",    badge: "طازج يومياً",    img: "/p-labneh-soft-new.jpg",            desc: "مصنوعة يومياً من أجود الحليب الطازج — ناعمة كالحرير تُقدَّم مع زيت الزيتون البكر." },
  { name: "لبنة جامدة",             accent: "جودة محفوظة دائماً",   cat: "لبنة",    badge: "طبيعي ١٠٠٪",    img: "/p-labneh-hard-new.jpg",       desc: "لبنة جامدة طبيعية مميزة — تُصنع بعناية للحفاظ على جودتها ونكهتها الأصيلة في كل وجبة." },
  { name: "لبنة جرشية",             accent: "خفيفة ومميزة",          cat: "لبنة",    badge: "طبيعي ١٠٠٪",    img: "/p-labneh-jarshiya-new.jpg",       desc: "لبنة جرشية بملمس خفيف ونكهة طبيعية مميزة — خيار راقٍ لمن يبحث عن التميز." },
  { name: "لبنة بالزيت · زعتر",     accent: "نكهة الصباح الأصيل",   cat: "لبنة",    badge: "صناعة محلية",   img: "/p-labneh-zaatar-new.jpg",         desc: "كرات لبنة منقوعة في زيت الزيتون البكر مع الزعتر البلدي — وصفة موروثة من بلاد الشام." },
  { name: "لبنة بالزيت · شطة",      accent: "نكهة قوية وجريئة",     cat: "لبنة",    badge: "صناعة محلية",   img: "/p-labneh-shatta-new.jpg",         desc: "كرات لبنة حارة بزيت الزيتون والشطة الطبيعية — لمن يُحب النكهة القوية والطعم الجريء." },
  { name: "فيتا ديرتنا",            accent: "من البحر المتوسط",      cat: "جبنة",    badge: "منتج مميز",      img: "/p-cheese-feta-new.png",           desc: "جبنة فيتا كريمية بنكهة متوسطية أصيلة — غنية ودسمة، مثالية مع الطماطم والزيتون." },
  { name: "جبنة حلوم",             accent: "طازجة ومثالية للشوي والقلي", cat: "حلوم",    badge: "طازج يومياً",    img: "/p-halloum-cheese.jpg",      desc: "جبنة حلوم بلدية طازجة، تتميز بقوامها المتماسك ونكهتها الغنية الفريدة، مثالية للشوي أو القلي." },
  ...
  { name: "لبنة بالزيت · سادة",     accent: "بساطة فاخرة",          cat: "لبنة",    badge: "صناعة محلية",   img: "/p-labneh-plain-new.png",          desc: "كرات لبنة نقية بأجود أنواع زيت الزيتون البكر — بساطة تحمل نكهة الأصالة الحقيقية." },
  { name: "لبن بقري",               accent: "طازج وغني بالقشطة",     cat: "مشروبات الألبان",  badge: "طازج يومياً",    img: "/p-yogurt-cow.jpg",            desc: "لبن بقري طازج وغني بالقشطة، يُصنع بالطريقة التقليدية يومياً من حليب ديرتنا الطازج." },
            ...
            <AnimatePresence mode="wait">
              <motion.div key={idx} variants={IMG_V}
                ...
                <div className="relative w-full h-full rounded-[2.5rem] overflow-hidden"
                  ...
                  {/* Studio spotlight behind product to blend white backgrounds seamlessly */}
                  <div className="absolute inset-0 pointer-events-none z-0"
                    style={{ background: "radial-gradient(circle at 50% 50%, rgba(255,255,255,0.50) 0%, transparent 68%)" }} />

                  <Image src={p.img} alt={p.name} fill
                    sizes="(max-width:1024px) 80vw, 44vw"
                    className="object-contain p-8 relative z-10"
                    style={{ filter: "contrast(1.06) brightness(1.03)", mixBlendMode: "multiply", transform: "scale(1.08)" }} />
